...
class Invitation(Portal):
    ...
    def __init__(self, host, port, invite):
        ...
        self.invite = invite
        self.clients.api = self.default.clone(clients.API, EndpointBuilder.new(self.base, self.context, f'/portalInvitation/share/{invite}'))
        self.clients.io._webdav = self.default.clone(clients.WebDAV, EndpointBuilder.new(self.base, self.context, f'/webdav/share/{invite}'))
        self.clients.io._upload = self.default.clone(clients.Upload, EndpointBuilder.new(self.base, self.context, f'/upload/share/{invite}'))
