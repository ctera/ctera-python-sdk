...
ATTRIBUTE_PATHS = {
    ...
    '.portals[].devices[].': [
        ...
        'deviceReportedStatus.storage.status.summary.allocatedDriveSpace',
        'deviceReportedStatus.storage.status.summary.availableDriveSpace',
        'deviceReportedStatus.storage.status.summary.encryptedVolumeCount',
        'deviceReportedStatus.storage.status.summary.logicalDriveSpace',
        'deviceReportedStatus.storage.status.summary.physicalDriveSpace',
        'deviceReportedStatus.storage.status.summary.spareDriveCount',
