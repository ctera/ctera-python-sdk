...
class TestEdgeMailServer(base_edge.BaseEdgeTest):
    ...
    def test_enable_mail_server_default_port_no_auth_with_tls(self):
        ...
        self._filer.api.get.assert_called_once_with('/config/logging/alert')
        self._filer.api.put.assert_called_once_with('/config/logging/alert', mock.ANY)
    ...
    def test_disable_mail_server(self):
        ...
        self._filer.api.put.assert_called_once_with('/config/logging/alert/useCustomServer', False)
