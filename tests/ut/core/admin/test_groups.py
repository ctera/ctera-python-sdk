...
class TestCoreGroups(base_admin.BaseCoreTest):
    ...
    def test_list_local_groups_default_attrs(self):
        with mock.patch("cterasdk.core.groups.query.iterator") as query_iterator_mock:
            ...
            expected_query_params = base_admin.BaseCoreTest._create_query_params(include=groups.Groups.default, start_from=0, count_limit=50)
