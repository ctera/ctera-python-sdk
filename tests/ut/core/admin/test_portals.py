...
class TestCorePortals(base_admin.BaseCoreTest):
    ...
    def test_get_tenant(self):
        ...
        self._global_admin.api.get_multi.assert_called_once_with('/portals/' + self._name, mock.ANY)
    ...
    def test_get_active_tenants(self):
        self._global_admin.api.execute = mock.MagicMock(side_effect=TestCorePortals._get_query_portals_response)
    ...
    def test_add_tenant_default_args(self):
        ...
        self._global_admin.api.add.assert_called_once_with('/teamPortals', mock.ANY)
    ...
    def test_subscribe(self):
        ...
        self._global_admin.api.execute.assert_called_once_with('/portals/' + self._name, 'subscribe', self._plan_name)
    ...
    def test_delete_portal(self):
        ...
        self._global_admin.api.execute.assert_called_once_with('/teamPortals/' + self._name, 'delete')
        self.assertEqual(ret, execute_response)
    ...
    def test_undelete_portal(self):
        ...
        self._global_admin.api.execute.assert_called_once_with('/teamPortals/' + self._name, 'moveFromTrashcan')
        self.assertEqual(ret, execute_response)

    def test_browse_tenant(self):
        self._init_global_admin()
        portals.Portals(self._global_admin).browse(self._name)
        self._global_admin.api.put.assert_called_once_with('/currentPortal', self._name)
