...
class TestMigrationTool(base_edge.BaseEdgeTest):
    ...
    def test_login(self):
        ...
        self._filer.migrate.login.assert_called_once_with('/migration/rest/v1/auth/user')  # pylint: disable=protected-access
    ...
    def test_list_shares(self):
        ...
        self._filer.migrate.post.assert_called_once_with('/migration/rest/v1/inventory/shares',  # pylint: disable=protected-access
                                                                mock.ANY)
        actual_param = self._filer.migrate.post.call_args[0][1]  # pylint: disable=protected-access
    ...
    def test_list_tasks_empty_response(self):
        ...
        self._filer.migrate.get.assert_called_once_with('/migration/rest/v1/tasks/list',  # pylint: disable=protected-access
                                                               {'deleted': int(False)})
    ...
    def test_delete(self):
        ...
        self._filer.migrate.post.assert_called_once_with('/migration/rest/v1/tasks/delete',  # pylint: disable=protected-access
                                                                mock.ANY)
        actual_param = self._filer.migrate.post.call_args[0][1]  # pylint: disable=protected-access
    ...
    def test_restore(self):
        ...
        self._filer.migrate.post.assert_called_once_with('/migration/rest/v1/tasks/restore',  # pylint: disable=protected-access
                                                                mock.ANY)
        actual_param = self._filer.migrate.post.call_args[0][1]  # pylint: disable=protected-access
        self._assert_equal_objects(actual_param, munch.Munch(task_ids=self._task_ids))
        self.assertEqual(ret, 'Success')
    ...
    def test_start(self):
        ...
        self._filer.migrate.post.assert_called_once_with('/migration/rest/v1/tasks/enable',  # pylint: disable=protected-access
                                                                mock.ANY)
        actual_param = self._filer.migrate.post.call_args[0][1]  # pylint: disable=protected-access
    ...
    def test_stop(self):
        ...
        self._filer.migrate.post.assert_called_once_with('/migration/rest/v1/tasks/disable',  # pylint: disable=protected-access
                                                                mock.ANY)
        actual_param = self._filer.migrate.post.call_args[0][1]  # pylint: disable=protected-access
        self._assert_equal_objects(actual_param, munch.Munch(task_id=self._task_id))
        self.assertEqual(ret, 'Success')
    ...
    def test_details(self):
        ...
        self._filer.migrate.get.assert_called_once_with('/migration/rest/v1/tasks/history',  # pylint: disable=protected-access
                                                               {'id': self._task_id})
    ...
    def test_add_discovery_job(self):
        ...
        self._filer.migrate.post.assert_called_once_with('/migration/rest/v1/tasks/create',  # pylint: disable=protected-access
                                                                mock.ANY)
    ...
    def test_update_discovery_job(self):
        ...
        self._filer.migrate.post.assert_called_once_with('/migration/rest/v1/tasks/update',  # pylint: disable=protected-access
                                                                mock.ANY)
        actual_param = self._filer.migrate.post.call_args[0][1]  # pylint: disable=protected-access
