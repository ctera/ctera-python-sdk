...
class TestMigrationTool(base_edge.BaseEdgeTest):
    ...
    def test_list_shares(self):
        ...
        self._filer.migrate.post.assert_called_once_with('/inventory/shares',  # pylint: disable=protected-access
                                                                mock.ANY)
    ...
    def test_delete(self):
        ...
        self._filer.migrate.post.assert_called_once_with('/tasks/delete',  # pylint: disable=protected-access
                                                                mock.ANY)
        actual_param = self._filer.migrate.post.call_args[0][1]  # pylint: disable=protected-access
    ...
    def test_restore(self):
        ...
        self._filer.migrate.post.assert_called_once_with('/tasks/restore',  # pylint: disable=protected-access
                                                                mock.ANY)
        actual_param = self._filer.migrate.post.call_args[0][1]  # pylint: disable=protected-access
        self._assert_equal_objects(actual_param, munch.Munch(task_ids=self._task_ids))
        self.assertEqual(ret, 'Success')
    ...
    def test_start(self):
        ...
        self._filer.migrate.post.assert_called_once_with('/tasks/enable',  # pylint: disable=protected-access
                                                                mock.ANY)
        actual_param = self._filer.migrate.post.call_args[0][1]  # pylint: disable=protected-access
    ...
    def test_stop(self):
        ...
        self._filer.migrate.post.assert_called_once_with('/tasks/disable',  # pylint: disable=protected-access
                                                                mock.ANY)
        actual_param = self._filer.migrate.post.call_args[0][1]  # pylint: disable=protected-access
        self._assert_equal_objects(actual_param, munch.Munch(task_id=self._task_id))
        self.assertEqual(ret, 'Success')
    ...
    def test_add_discovery_job(self):
        ...
        self._filer.migrate.post.assert_called_once_with('/tasks/create',  # pylint: disable=protected-access
                                                                mock.ANY)
    ...
    def test_update_discovery_job(self):
        ...
        self._filer.migrate.post.assert_called_once_with('/tasks/update',  # pylint: disable=protected-access
                                                                mock.ANY)
        actual_param = self._filer.migrate.post.call_args[0][1]  # pylint: disable=protected-access
