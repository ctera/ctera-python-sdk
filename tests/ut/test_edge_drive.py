...
class TestEdgeDrive(base_edge.BaseEdgeTest):
    ...
    def test_get_all_drives(self):
        ...
        self._filer.api.get.assert_called_once_with('/config/storage/disks')
    ...
    def test_get_drive(self):
        ...
        self._filer.api.get.assert_called_once_with('/config/storage/disks/' + self._drive_name)
        self.assertEqual(ret, get_response)

    def test_format_drive(self):
        self._init_filer()
        drive.Drive(self._filer).format(self._drive_name)
        self._filer.api.execute.assert_called_once_with('/proc/storage', 'format', mock.ANY)
