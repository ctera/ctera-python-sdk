...
class TestEdgeRSync(base_edge.BaseEdgeTest):
    ...
    def test_get_configuration(self):
        ...
        self._filer.get.assert_called_once_with('/config/fileservices/rsync')
    ...
    def test_enable_ftp(self):
        ...
        self._filer.put.assert_called_once_with('/config/fileservices/rsync/server', Mode.Enabled)
    ...
    def test_modify_success(self):
        ...
        self._filer.get.assert_called_once_with('/config/fileservices/rsync')
        self._filer.put.assert_called_once_with('/config/fileservices/rsync', mock.ANY)
