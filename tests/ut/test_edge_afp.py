...
class TestEdgeAFP(base_edge.BaseEdgeTest):
    ...
    def test_afp_is_disabled(self):
        ...
        self._filer.api.get.assert_called_once_with('/config/fileservices/afp/mode')
    ...
    def test_disable_afp(self):
        ...
        self._filer.api.put.assert_called_once_with('/config/fileservices/afp/mode', Mode.Disabled)
