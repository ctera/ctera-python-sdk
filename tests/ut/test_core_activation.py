...
class TestCoreActivation(base_core.BaseCoreTest):
    ...
    def test_generate_code_user_and_tenant(self):
        ...
        self._global_admin.api.get.assert_called_once_with('/ssoActivation', dict(username=self._username, portal=self._portal))
    ...
    def test_generate_code_user_only(self):
        ...
        self._global_admin.api.get.assert_called_once_with('/ssoActivation', dict(username=self._username))
        self.assertEqual(code, self._expected_code)
